...
Require Import paconotation_internal.
...
Proof.
  intros. destruct H. unfold monotone14.
  intros. eapply gf_mon; [apply IN|].
...
Proof.
  ...
  - intros. punfold PR0.
    eapply (gfclo14_mon UPTO).
    + apply PR0.
    + intros. destruct PR1; [apply H | destruct H].
  - pfold. apply PR.
Qed.
...
Proof.
  ...
  destruct grespectful14_respectful14; eapply RESPECTFUL0, PR; intros; [apply grespectful14_incl; auto|].
  punfold PR0.
