...
print ('    eapply (gfclo'+str(n)+'_mon UPTO).')
print ('    + apply PR0.')
print ('    + intros. destruct PR1; [apply H | destruct H].')
...
print ('  }')
print ('  induction n; intros; simpl in *.')
print ('  - eapply gf_mon.')
print ('    + clear RESPECTFUL0. eapply PFIX, PR.')
print ('    + intros. right. eapply PR0.')
print ('  - destruct PR.')
print ('    + eapply gf_mon; [eapply IHn, H0|]. intros. clear - PR. auto.')
print ('    + eapply gf_mon; [eapply RESPECTFUL0; [|apply IHn|]|]; instantiate; simpl; auto.')
print ('Qed.')
print ('')
...
print ('  destruct grespectful'+str(n)+'_respectful'+str(n)+'; eapply RESPECTFUL0, PR; intros; [apply grespectful'+str(n)+'_incl; auto|].')
print ('  punfold PR0.')
